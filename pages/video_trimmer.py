...
# Initialize session state for trimmed videos
...
if uploaded_video:
    ...
    if st.button("🎬 Generate Clips"):
        st.session_state["trimmed_videos"] = []  # Clear previous clips
...
# Display download buttons for each generated clip
if st.session_state["trimmed_videos"]:
    st.header("📥 Download Your Clips")
